...
<nav style="margin-left:70%;color:ffffff;"> 
 |<!--Pinkish Red Neon #ff0055-->
<a href="#Support" style="color:#ff9933;margin-left:20px;">SUPPORT</a> |<!--Neon Carrot #ff9933-->
<a href="logout.php" style="color:#ff0055;;margin-left:20px;">LOGOUT</a>
</nav>
</div>
...
<input type="hidden" value="<?php echo $id; ?>" name="d1"
...
<a href="display.php?name=ric & id=<?php echo $id; ?>"
...
<a href="display.php?name=mini&id=<?php echo $id; ?>""
